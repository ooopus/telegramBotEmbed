...
# 默认配置
DEFAULT_CONFIG = {
    'TOKEN': '1234567890:12345678901234567890123456789012345',
...
try:
    ...
    print("建议参考 config.example.py 创建配置文件")
    TOKEN = DEFAULT_CONFIG['TOKEN']
    API_KEY = DEFAULT_CONFIG['API_KEY']
    EMBED_API_URL = DEFAULT_CONFIG['EMBED_API_URL']
    ...
    DELETE_DELAY = DEFAULT_CONFIG['DELETE_DELAY']
    MESSAGE_TIMEOUT = DEFAULT_CONFIG['MESSAGE_TIMEOUT']
